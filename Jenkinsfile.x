      ...
      stage("Fetch Patchset") { // fetch gerrit refspec on latest commit
          try {
              ...
              sh '''
                 ...
                 cd $PROJECT_DIR && git clone --single-branch -b master https://github.com/rameshthoomu/$PROJECT
                 git clone --single-branch -b master https://github.com/hyperledger/fabric
              '''
              }
          }
          catch (err) {
